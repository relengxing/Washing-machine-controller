...
void SX1276LoRaSetRFFrequency( uint32_t freq )
{
	...
	SX1276Write( REG_LR_FRFMSB, SX1276LR->RegFrfMsb );
	SX1276Write( REG_LR_FRFMID, SX1276LR->RegFrfMid );
	SX1276Write( REG_LR_FRFLSB, SX1276LR->RegFrfLsb );
}
...
void SX1276LoRaSetRFPower( int8_t power )
{
    ...
    if( ( SX1276LR->RegPaConfig & RFLR_PACONFIG_PASELECT_PABOOST ) == RFLR_PACONFIG_PASELECT_PABOOST )
    {
        if( ( SX1276LR->RegPaDac & 0x87 ) == 0x87 )
        {
            ...
            SX1276LR->RegPaConfig = ( SX1276LR->RegPaConfig & RFLR_PACONFIG_OUTPUTPOWER_MASK ) | ( ( power - 5 ) & 0x0F );
        }
        else
        {
            if(power < 2 )
            ...
            SX1276LR->RegPaConfig = ( SX1276LR->RegPaConfig & RFLR_PACONFIG_MAX_POWER_MASK ) | 0x70;
            SX1276LR->RegPaConfig = ( SX1276LR->RegPaConfig & RFLR_PACONFIG_OUTPUTPOWER_MASK ) | ( ( power - 2 ) & 0x0F );
        }
    }
    else
    {
        ...
        SX1276LR->RegPaConfig = ( SX1276LR->RegPaConfig & RFLR_PACONFIG_MAX_POWER_MASK ) | 0x70;
        SX1276LR->RegPaConfig = ( SX1276LR->RegPaConfig & RFLR_PACONFIG_OUTPUTPOWER_MASK ) | ( ( power + 1 ) & 0x0F );
    }
...
void SX1276LoRaSetPreambleLength( uint16_t value )
{
	...
	SX1276Write( REG_LR_PREAMBLEMSB, SX1276LR->RegPreambleMsb );
	SX1276Write( REG_LR_PREAMBLELSB, SX1276LR->RegPreambleLsb );
}
...
void SX1276LoRaSetSymbTimeout( uint16_t value )
{
	...
	SX1276Write( REG_LR_MODEMCONFIG2, SX1276LR->RegModemConfig2 );
	SX1276Write( REG_LR_SYMBTIMEOUTLSB, SX1276LR->RegSymbTimeoutLsb );
}
...
void SX1276LoRaSetOptimizedReceiverResponse(void)
{
	  SX1276Read( REG_LR_TESTREERVED31, &SX1276LR->RegTestReserved31 );
	  SX1276LR->RegTestReserved31 = (SX1276LR->RegTestReserved31 & 0x7F);
	  SX1276Write( REG_LR_TESTREERVED31, SX1276LR->RegTestReserved31 );
}
