...
//#define RFRX_LONG_PREAMBLE_LENGTH                    8
//#define RFTX_LONG_PREAMBLE_MASTTOMETER_LENGTH        8	 //8	//870 长沙大水表 2015.04.08 6S  胜基20150619 20150722 //430 测试  盛帆 带阀水表 2015.06.19  //8 宝鸡演示 2015.06.18 温度面板
//#define RFTX_LONG_PREAMBLE_MASTTOCOLL_LENGTH         8

//#define BSP_1278_FREQ_OFFSET						1130000ul //
#define BSP_1278_FREQ_BASE							470000000ul //

//#define BSP_1278_FREQ_OFFSET						1130000ul //
#define BSP_1278_FREQ_OFFSET_1						251000ul //
#define BSP_1278_FREQ_OFFSET_2						257000ul //


/*!
 * SX1276 LoRa General parameters definition
 */
__packed typedef struct sLoRaSettings
{
    INT32U 	RFFrequency;               //
	INT8U  	Channel_RF;				// 信道号
    INT8U 	Power;                     //
    INT8U  	SignalBw;                  // LORA [0: 7.8 kHz, 1: 10.4 kHz, 2: 15.6 kHz, 3: 20.8 kHz, 4: 31.2 kHz,
                                        // 5: 41.6 kHz, 6: 62.5 kHz, 7: 125 kHz, 8: 250 kHz, 9: 500 kHz, other: Reserved]  
    INT8U  	SpreadingFactor;           // LORA [6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]
    INT16U  RF_Rx_Preamable_Len ;	    // 接收preamable 长度
    INT16U 	RF_Tx_S_Master_Preamable_Len ;	// 发送给主模块 preamable 长度 
    INT16U 	RF_Tx_S_Meter_Preamable_Len ;	// 发送给表计 preamable 长度
	
    INT8U  	ErrorCoding;               // LORA [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
    bool 	CrcOn;                     // [0: OFF, 1: ON]
    bool 	ImplicitHeaderOn;          // [0: OFF, 1: ON]
    bool 	RxSingleOn;                // [0: Continuous, 1 Single]
    bool   	FreqHopOn;                 // [0: OFF, 1: ON]
    INT8U  	HopPeriod;                 // Hops every frequency hopping period symbols
    INT32U 	TxPacketTimeout;			
    INT32U 	RxPacketTimeout;
    INT8U  	PayloadLength;
}tLoRaSettings;
...
#define REG_LR_TESTREERVED31                        0x31
